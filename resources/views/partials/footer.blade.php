<div class="banner__bottom bg-light text-center p-2">
    MÁS PUBLICIDAD! <strong>SUBSCRÍBETE A NUESTRA NEWSLETTER</strong> <a href="https://impactacomunicacion.com/" target="blank">Clic aquí</a>
</div>
<div class="container-fluid p-4 pb-0">
    <div class="container">
        <div class="row mt-3">
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                <h4>Contacto y Preguntas Frecuentes</h4>
                <ul class="nav flex-column text-light fs-6">
        ...
        <div class="row mt-3 pb-2">
            ...
            <a class="navbar-brand d-flex justify-content-end" href="{{ route('welcome') }}">
                <img src="{{ asset('storage/images/logos/impacta2.svg') }}" alt="Logo Impacta" style="height: 20px;">
            </a>    
        </div>
    </div>
</div>
